...
public class StreamingAggregationRestHandler extends BaseRestHandler implements RestHandler {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel, Client client) {
        ...
        } else if (request.hasParam("newDocument")) {
            SourceToParse source = SourceToParse.source(request.content());
            gson.fromJson(new String(request.content().toBytes()), HashMap.class);
